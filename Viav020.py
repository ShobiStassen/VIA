...
def main_Human():
    ...
    gene_list = ['GATA1', 'GATA2', 'ITGA2B', 'CSF1R', 'MPO', 'CD79B', 'SPI1', 'IRF8', 'CD34', 'IL3RA', 'ITGAX', 'IGHD',
    ...
    for ti in p1.revised_super_terminal_clusters:  # p0.terminal_clusters:
        ...
        ax2.scatter(embedding[new_tsi_list[jj], 0], embedding[new_tsi_list[jj], 1], label='TS' + str(tsi_list[jj]),
                    c='pink', s=18)  # PCs HNSW
